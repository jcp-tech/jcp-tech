...
def export_data():
    ...
    output_path = os.path.join(os.path.dirname(__file__), "backup", "56cdf0549e21084f82eba54015e4e64d", 'firebase_data_backup.json') # NOTE: The Sub Folder is from a PrivateGitHub GIST which is used to store the backup data.
